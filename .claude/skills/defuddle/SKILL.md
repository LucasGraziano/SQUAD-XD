...
- Competitor landing pages, ad references
- Research articles, blog posts
- Documentation pages
- Any URL before ingesting into the wiki (`/wiki-ingest`)

## When NOT to use

- URLs ending in `.md` — use WebFetch directly
- APIs returning JSON — use WebFetch directly
- Files on local disk — use Read tool
